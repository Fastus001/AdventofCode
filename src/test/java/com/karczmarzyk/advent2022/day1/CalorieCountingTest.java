...
class CalorieCountingTest {
    ...
    void getMaxTotalCaloriesTestCase() throws IOException {
        ...
        final Integer maxTotalCalories = cc.getMaxTotalCalories(Files.readAllLines(Path.of("src/main/resources/2022/day1/day2-2022test.txt")));
    ...
    void getMaxTotalCaloriesPart1() throws IOException {
        ...
        final Integer maxTotalCalories = cc.getMaxTotalCalories(Files.readAllLines(Path.of("src/main/resources/2022/day1/day2-2022.txt")));
    ...
    void getMaxTotalCaloriesPart2() throws IOException {
        ...
        final Integer maxTotalCalories = cc.getMaxTotalCaloriesPart2(Files.readAllLines(Path.of("src/main/resources/2022/day1/day2-2022.txt")));
